...
PanelForge is a private-writing modular monolith. Server components read scoped data; server actions and typed route handlers validate, authenticate, authorize, and mutate. PostgreSQL/Prisma is canonical.
