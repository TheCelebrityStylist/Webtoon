...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${site.url}/webtoons`, lastModified: now, changeFrequency: "daily", priority: 0.95 },
    ...
    { url: `${site.url}/for-creators`, lastModified: now, changeFrequency: "weekly", priority: 0.82 },
